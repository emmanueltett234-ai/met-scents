    ...
    return (
      <div className="container-luxe flex flex-col items-center gap-4 py-32 text-center">
        ...
        <p className="max-w-sm text-sm text-muted-foreground">
          Browse the catalogue and tap &ldquo;Add to Enquiry&rdquo; on any fragrance to build your
          selection.
        </p>
  ...
  return (
    <div className="container-luxe py-16">
      <div className="mb-10 text-center">
        <p className="kicker mb-3">Review &amp; Submit</p>
        <h1 className="font-serif text-4xl">My Selection</h1>
            ...
            {items.map((item) => (
              <div key={item.variantId} className="flex items-center gap-4 py-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <Link href={`/products/${item.slug}`} className="font-serif text-lg hover:text-gold-dark">
                    {item.name}
                  </Link>
